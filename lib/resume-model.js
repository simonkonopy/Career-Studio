...
function createResumeModel() {
  ...
  return { blankProfile, normalizeProfile, skillTasks, skillInterviewQuestions, normalizeSkillTaskLabel, isSafeSkillTaskLabel, detectSkills, importText, questions, resumeText, resumeHtml, matchJobs };
}
